...
from layers.ssd_layers import Normalize, PriorBox, AnchorBoxes, DecodeDetections, DecodeDetections2, L2Normalization

import numpy as np
from keras.layers import Input, Lambda, Activation, Conv2D, MaxPooling2D, ZeroPadding2D, Reshape, Concatenate
from keras.regularizers import l2

from layers.ssd_layers import AnchorBoxes
from layers.ssd_layers import L2Normalization
from layers.ssd_layers import DecodeDetections
from layers.ssd_layers import DecodeDetections2

def build_ssd300(img_shape=(300, 300,3), n_classes=21, n_priors=5,
    ...
    model = SSD300_plf((300,300,3), n_classes,
                       scales=scales_voc,offsets=offsets)
...
"""
    SSD300 model construction
    code adapted from https://github.com/pierluigiferrari/ssd_keras
"""
def SSD300_plf(image_size,
            n_classes,
            mode='training',
...
"""
def SSD300_rykov(input_shape, num_classes=21):
    """SSD300 architecture.
    ...
    net['mbox_loc'] = keras.layers.merge([net['conv4_3_norm_mbox_loc_flat'],
    ...
    net['mbox_conf'] = keras.layers.merge([net['conv4_3_norm_mbox_conf_flat'],
    ...
    net['mbox_priorbox'] = keras.layers.merge([net['conv4_3_norm_mbox_priorbox'],
    ...
    net['predictions'] = keras.layers.merge([net['mbox_loc'],
                               net['mbox_conf'],
                               net['mbox_priorbox']],
