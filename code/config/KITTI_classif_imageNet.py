...
resize_train                 = (128, 128)      # Resize the image during training (Height, Width) or None
resize_valid                 = (128, 128)      # Resize the image during validation
resize_test                  = (128, 128)      # Resize the image during testing
...
earlyStopping_patience       = 15             # Max patience for the early stopping
...
lrDecayScheduler_epochs      = [15, 25, 40]     # List of epochs were decay is applied or None for all epochs
